...
import { denoKvAdapter } from "./deno";

export type MyOptions = {};

export const getAuth = (kv: Deno.Kv) =>
  lucia({
    adapter: denoKvAdapter(kv),
...
export const prisma_denoKvAdapter = <_PrismaClient extends PrismaClient>(
  config:
    | {
